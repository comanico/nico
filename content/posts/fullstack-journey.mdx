...
description: How I Went from Incident Management to Full-Stack Engineer in 6 Months
...
This post is the overview. In future posts, I’ll dive into the details of each project, the decisions, the trade-offs and the lessons learned that any aspiring developer can benefit from.
If you’re considering making the same leap, I hope my journey gives you both a realistic picture and the motivation to get started.

## Neva Apartments - Getting comfortable with AWS and Stripe
...
![Neva Apartments](Neva_Apartments.png)
...
A key milestone was integrating Stripe payments, enabling secure transactions through Stripe’s prebuilt checkout and clear API.
This project demonstrated how a tutorial can be transformed into a practical solution, combining TypeScript, AWS, and Stripe into a functioning booking platform tailored for a real business.

## Comanico.Biz - Centralizing My Developer Portfolio and Blog
...
## Investo Bar - Gamifying the Stock Market Through Drink Prices

![Investo Bar](InvestoBar.png)
